...
// Main class
public class OOPHouseExample {
    public static void main(String[] args) {
        // House 1
        House h1 = new House("Krishna", "Chennai", 3, 2);
        h1.build();
        h1.showDetails();
        ...
        // House 2
        House h2 = new House("Coimbatore", 2);
        h2.build();
        h2.showDetails();
        ...
        // Villa
        Villa v1 = new Villa("Boss", "ECR, Chennai", 5, 3, true);
        v1.build();
        v1.showDetails();
    }
}
